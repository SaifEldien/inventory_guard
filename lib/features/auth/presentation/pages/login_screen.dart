                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'The most advanced asset management platform\nfor modern businesses.',
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          builder: (context, state) {
                            return ElevatedButton(
                              ...
                              child: state is AuthLoading 
                                ...
                                : Text('Sign in to Dashboard', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w700, fontSize: 15)),
                            );
                          },
                        ),
                        const SizedBox(height: 24),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('Don\'t have an account?', style: GoogleFonts.plusJakartaSans(color: AppColors.textSecondary)),
                            TextButton(
